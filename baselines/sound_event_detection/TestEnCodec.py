...
if __name__ == '__main__':
    ...
    parser.add_argument("-m", '--model_path', type=str, default='/data/ckpts/dcase20_baseline_model.p',
    ...
    parser.add_argument("-ga", '--groundtruth_audio_dir', type=str, default='/home/work/jjk/data/audioset/audioset/audio/validation',
    ...
    parser.add_argument("-br", "--bitrate", type=float, default=24.0, help="bitrate for EnCodec")
    ...
    dataset = DESED(base_feature_dir=osp.join(cfg.workspace, "dataset", "features"), compute_log=False, recompute_features=True, use_encodec=True, bitrate=f_args.bitrate)
    ...
    single_predictions = get_predictions(params["model"], params["dataloader"],
                                         ...
                                         save_predictions=f_args.save_predictions_path, encodec=True, bitrate=f_args.bitrate)
